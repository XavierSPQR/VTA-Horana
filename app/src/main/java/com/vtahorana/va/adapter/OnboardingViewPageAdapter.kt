package com.vtahorana.va.adapter
...
import com.vtahorana.va.R
import com.vtahorana.va.model.OnboardingData

class OnboardingViewPageAdapter(private var context:Context, private var onBoardingDataList:List<OnboardingData>): PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        title=view.findViewById(R.id.ontitle)
